...
class MacDataFrameAccessor:
    ...
    def any_duplicates(self, col: str, ignore_nan: bool = False):
        ...
        return mppd.any_duplicates(self._df, col, ignore_nan=ignore_nan)
    ...
    def compare(self, right: pd.DataFrame, filter_kwargs={}, **kwargs):
        ...
        return mppd.compare(self._df, right, filter_kwargs=filter_kwargs, **kwargs)
    ...
    def date_proximity(
        ...
        """see :func:`macpie.pandas.date_proximity`"""
        return mppd.date_proximity(
            self._df,
            right,
            id_on=id_on,
    ...
    def filter_labels_pair(
        ...
        return mppd.filter_labels_pair(
            self._df,
            right,
            filter_kwargs=filter_kwargs,
    ...
    def insert(self, col_name, col_value, allow_duplicates=False):
        ...
        return mppd.insert(self._df, col_name, col_value, allow_duplicates=allow_duplicates)

    def is_date_col(self, arr_or_dtype):
        """see :meth:`macpie.pandas.is_date_col`"""
        return mppd.is_date_col(self._df[arr_or_dtype])

    def mark_duplicates_by_cols(self, cols: List[str]):
        """see :meth:`macpie.pandas.mark_duplicates_by_cols`"""
        return mppd.mark_duplicates_by_cols(self._df, cols)
    ...
    def mimic_dtypes(self, right: pd.DataFrame, categorical=True):
        ...
        return mppd.mimic_dtypes(self._df, right, categorical=categorical)

    def mimic_index_order(self, right, axis=None):
        """see :meth:`macpie.pandas.mimic_index_order`"""
        return mppd.mimic_index_order(self._df, right, axis=axis)

    def prepend_multi_index_level(self, level_name: str, axis: int = 0):
        return mppd.prepend_multi_index_level(self._df, level_name, axis=axis)

    def replace_suffix(self, old_suffix, new_suffix):
        """see :meth:`macpie.pandas.replace_suffix`"""
        return mppd.replace_suffix(self._df, old_suffix, new_suffix)
    ...
    def sort_values_pair(self, right, right_only=False, axis="index", **kwargs):
        ...
        return mppd.sort_values_pair(self._df, right, right_only=right_only, axis=axis, **kwargs)
    ...
    def to_datetime(self, date_col_name):
        ...
        return mppd.to_datetime(self._df, date_col_name)
